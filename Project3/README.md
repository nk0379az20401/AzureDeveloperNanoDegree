...
| ---------------- | ------------ | --------------|
| Azure PostgreSQL |   Basic      |   2500 INR    |
| Azure Service Bus|   Basic      |   5    INR    |
...
TECHCONF 2022 web application pushed the notifications to ServiceBus Queue and notifications are popped from queue and process by Azure functions. Moving to a background task is the most cost effective solution.

Overall this architecture is scalable and response time is very fast.
